"""Orquestador enfoque7.5 — réplica de enfoque7.1 sobre NVIDIA NIM.
...
oficial `TeamName_SolutionName_SPA2MSLG.txt`.
"""
...
def _print_summary(summary: list):
    print(f"\n{'='*60}")
    print(f"  RESUMEN — ENFOQUE 7.5 (NVIDIA NIM: {config.NVIDIA_MODEL})")
    print(f"{'='*60}")
